...
export default function Browse() {
	...
	const continueWatchingtv = useFetchContent(requests.fetchcontinueWatchingtv);
	const netflixOriginals = useFetchContent(requests.fetchNetflixOriginals);
	const actionAndAdventureSeries = useFetchContent(
		requests.fetchActionAndAdventureSeries
	);
	...
	const warAndPoliticsSeries = useFetchContent(
		requests.fetchWarAndPoliticsSeries
	);
	const westernSeries = useFetchContent(requests.fetchWesternSeries);
	const latestMovies = useFetchContent(requests.fetchlatestMovies);
	const continueeWatchingtv = useFetchContent(requests.fetchcontinueeWatchingtv);
