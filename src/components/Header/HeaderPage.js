			...
			{userId ? (
								...
								<div className="flex items-center divide-x divide-gray-100 border-x border-gray-100">
									...
									<span>
										<Link
											onClick={logout}
											to="/"
											className="block border-b-4 border-transparent p-6 hover:border-black font-semibold"
										>
											Logout
				...
				<ul>
					<div className="flex items-center ">
						...
						<div className="flex flex-1 items-center justify-end divide-x divide-gray-100 border-x border-gray-100">
							<span>
								<Link
									to="/login"
									className="block border-b-4 border-transparent p-6 hover:border-black font-semibold"
